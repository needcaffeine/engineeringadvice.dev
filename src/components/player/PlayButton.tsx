...
export default function PlayButton({ episode }: Props) {
  ...
  return (
    <div class="flex h-16 w-16 items-center justify-center">
      <button
        class="bg-light-text-heading flex h-14 w-14 items-center justify-center rounded-full text-white transition-all duration-300 hover:h-16 hover:w-16 hover:bg-linear-to-r hover:from-[#0F766E] hover:to-[#0EA5E9] dark:bg-white dark:text-[#24263D] dark:hover:from-[#2DD4BF] dark:hover:to-[#7DD3FC]"
        type="button"
        onClick={() => {
          if (episode) {
